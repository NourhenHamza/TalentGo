...
const LoginCompany = () => {
  const { setCompanyToken, backendUrl } = useContext(AppContext);
  const navigate = useNavigate();

  const onSubmitHandler = (event) => {
    event.preventDefault();
    window.open("http://localhost:5174/company-login", "_blank");
  };
            ...
            <div className="grid md:grid-cols-2">
              ...
              <div className="p-8 md:p-10 order-2 md:order-1">
                <div className="h-full flex flex-col">
                  <div className="mb-8">
                    ...
                    <h2 className="text-2xl font-bold text-slate-800 mb-2">Company Portal</h2>
                  ...
                  <div className="relative bg-blue-600 rounded-2xl shadow-lg p-6 text-white overflow-hidden mb-8 flex-grow">
                    ...
                    <div className="relative z-10">
                      <h3 className="text-xl font-semibold mb-3">Manage Student Projects</h3>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      ...
                      <p className="ml-4 text-slate-600">Schedule meetings</p>
                    </motion.div>
              ...
              <div className="bg-gradient-to-br from-blue-500 to-blue-600 p-8 md:p-10 flex flex-col justify-center order-1 md:order-2 relative overflow-hidden">
                ...
                <div className="text-center mb-10 relative z-10">
                  <h2 className="text-3xl font-bold text-white mb-2">Company Access</h2>
                  <p className="text-blue-100">Sign in to your company account to manage student projects</p>
                </div>
                ...
                >
                  <span>Login to Company Dashboard</span>
                  <svg 
                ...
                <div className="mt-12 text-center relative z-10">
                  <p className="text-blue-100 text-sm">
                    ...
                    Contact support at <span className="text-white font-medium">support@company.edu</span>
                  </p>
                </div>
              </div>
            </div>
