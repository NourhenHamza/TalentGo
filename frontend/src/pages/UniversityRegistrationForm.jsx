...
const UniversityRegistrationForm = () => {
  ...
  const validateForm = () => {
    const { name, description, contactPerson } = formData
    const { email, name: contactName } = contactPerson

    if (!name.trim() || !description.trim() || !contactName.trim() || !email.trim()) {
      toast.error("Please fill in all required fields.")
      return false
    }
    if (!/^\S+@\S+\.\S+$/.test(email)) {
      toast.error("Please enter a valid email address for the contact person.")
      return false
    }
    return true
  }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("/api/globaladmin/universities/request-registration", {
        method: "POST",
        headers: {
      ...
      toast.success("Your registration request has been submitted successfully! We will contact you soon.")
      setFormData({
        name: "",
        description: "",
        address: {
          ...
          <div className="grid md:grid-cols-5 gap-8 items-start">
            ...
            <div className="md:col-span-2 text-center md:text-left">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                <div className="mb-6">
                  ...
                  <h1 className="text-3xl md:text-4xl font-bold text-slate-800 mb-2">University Portal</h1>
                  <p className="text-slate-500 text-lg">Join Our Academic Network</p>
                </div>
                ...
                <div className="hidden md:block">
                  <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-xl p-8 text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-blue-50 mb-6">
                        Connect with industry partners and provide students with world-class internship opportunities
                      </p>

                      {/* Animated university icon */}
                      <motion.div
                        animate={{
                          y: [0, -10, 0],
                        }}
                  ...
                  <div className="mt-8 space-y-4">
                    ...
                    >
                      ...
                      <p className="ml-4 text-slate-600">Access to premium internship programs</p>
                    </motion.div>
                    ...
                    >
                      ...
                      <p className="ml-4 text-slate-600">Partnership with leading companies</p>
                    </motion.div>
                    ...
                    >
                      ...
                      <p className="ml-4 text-slate-600">Comprehensive student management tools</p>
                    </motion.div>
                  </div>
                </div>
              </motion.div>
            ...
            >
              <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10 border border-slate-100 relative">
                ...
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-slate-800 mb-2">University Registration</h2>
                  <p className="text-slate-500">Join our network and unlock opportunities for your students</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-2 mb-4">
                      ...
                      <h3 className="text-lg font-semibold text-slate-800">University Information</h3>
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        rows={3}
                        placeholder="Brief description of your university and its mission..."
                        required
                      />
                    </div>
                  </div>
                ...
                <div className="mt-8 text-center">
                  <p className="text-slate-500 text-sm">
                    Your registration request will be reviewed by our team.
                    <br />
