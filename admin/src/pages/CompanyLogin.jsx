          ...
          <div className="grid md:grid-cols-5 gap-8 items-center">
            ...
            <div className="md:col-span-2 text-center md:text-left">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                <div className="mb-6">
                  ...
                  <p className="text-slate-500 text-lg">Partner with Students and Faculty</p>
                </div>
                ...
                <div className="hidden md:block">
                  <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-xl p-8 text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      <h3 className="text-xl font-semibold mb-4">Company Portal</h3>
                      <p className="text-blue-50 mb-6">Access talented students and collaborate with university faculty on projects</p>
                  ...
                  <div className="mt-8 space-y-4">
                    ...
                    >
                      ...
                      <p className="ml-4 text-slate-600">Post internship opportunities</p>
                    </motion.div>
                    ...
                    >
                      ...
                      <p className="ml-4 text-slate-600">Review student applications</p>
                    </motion.div>
                    ...
                    >
                      ...
                      <p className="ml-4 text-slate-600">Collaborate with university</p>
                    </motion.div>
                  </div>
                </div>
              </motion.div>
            ...
            >
              <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10 border border-slate-100 relative">
                ...
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-slate-800 mb-2">Company Authentication</h2>
                  <p className="text-slate-500">Sign in to manage internships and collaborations</p>
                </div>
                ...
                <div className="mt-8 text-center">
                  <p className="text-slate-500 text-sm">
                    Don't have an account? <span className="text-blue-600 hover:text-blue-800 cursor-pointer">Contact university</span>
                  </p>
                  <p className="text-slate-400 text-xs mt-2">
                    This portal is restricted to authorized company representatives only
                  </p>
                </div>
              </div>
            </motion.div>
